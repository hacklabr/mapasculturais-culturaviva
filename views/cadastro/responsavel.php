<?php
    ...
    $this->cadastroIcon = 'icon-responsavel';
...
<form ng-controller="CadastroController">
    ...
    <div class="form form-opcional">
        ...
        <label class="facebook">
            ...
            <input type="text" ng-model="agent.facebook" placeholder="http://"/>
        </label>

        <label class="twitter">
            <span>Seu perfil no Twitter</span>
            <input type="text" ng-model="agent.twitter" placeholder="http://"/>
        </label>

        <label class="googleplus">
            <span>Seu perfil no Google+</span>
            <input type="text" ng-model="agent.google" placeholder="http://"/>
        </label>
    </div>
</form>