    ...
    <div class="form">
        ...
        <div class="row">
            <div class="colunm-full">
                <span class="destaque" ng-if="agent_entidade.tipoPontoCulturaDesejado != 'pontao'">Em qual edital do Ministério da Cultura a entidade/coletivo já foi contemplado? <i class="hltip" title='Caso nunca tenha sido contemplado, selecione "Ainda não fui Contemplado"'>?</i><br>(Pode escolher mais de uma opção) </span>
                <span class="destaque" ng-if="agent_entidade.tipoPontoCulturaDesejado == 'pontao'">Em qual edital do Ministério da Cultura a entidade/coletivo já foi contemplado?* <i class="hltip" title='Caso nunca tenha sido contemplado, selecione "Ainda não fui Contemplado"'>?</i><br>(Pode escolher mais de uma opção) </span>
            </div>
        ...
        <div class="row">
          <h4> Articulação </h4>
            <div class="colunm-full">
                <span class="destaque" ng-if="agent_entidade.tipoPontoCulturaDesejado != 'pontao'">Participa de algum movimento político-cultural? </span>
                <span class="destaque" ng-if="agent_entidade.tipoPontoCulturaDesejado == 'pontao'">Participa de algum movimento político-cultural?* </span>
            </div>
            <label class="colunm1">
                <input type="radio"
            ...
            <div class="colunm-full">
                <span class="destaque" ng-if="agent_entidade.tipoPontoCulturaDesejado != 'pontao'">Participa de algum Fórum de Cultura? </span>
                <span class="destaque" ng-if="agent_entidade.tipoPontoCulturaDesejado == 'pontao'">Participa de algum Fórum de Cultura?* </span>
            </div>
            <label class="colunm1">
                <input type="radio"
