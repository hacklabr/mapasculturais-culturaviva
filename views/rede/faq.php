<section id="page-faq">
    <article class="slide-home">
        <img src="<?php $this->asset('img/cultura-viva-share.png') ?>" />
        <ul>
            <li><a href="#somos_todos"> Somos todos Pontos de Cultura <span class="icon icon-plus-circled"></span></a></li>
            <li><a href="#cultura_viva">O que é Cultura Viva<span class="icon icon-plus-circled"></span></a></li>
            <li><a href="#ponto_e_pontao">O que é Ponto e Pontão de Cultura?<span class="icon icon-plus-circled"></span></a></li>
            <li><a href="#por_que_ponto_e_postao">Por que ser Ponto ou Pontão de Cultura?<span class="icon icon-plus-circled"></span></a></li>
            <li><a href="#o_que_ganho">O que eu ganho com isso?<span class="icon icon-plus-circled"></span></a></li>
            <li><a href="#autodeclarar">Como me Autodeclarar Ponto ou Pontão de Cultura?<span class="icon icon-plus-circled"></span></a></li>
        </ul>
    </article>
    ...
    <article class="content_faq">
        ...
        <div class="row">
            ...
            <p>Tem o objetivo de promover a articulação destas iniciativas em rede, contribuindo para a inclusão social, o combate ao preconceito e a todas as formas de discriminação e intolerância, o reconhecimento e a valorização da diversidade cultural brasileira e o pleno exercício dos direitos culturais.</p>
            <p>Desde 23 de julho de 2014, com a sanção da Lei Cultura Viva (Lei nº 13.018/2014), o Programa Cultura Viva e os Pontos e Pontões de Cultura tornaram-se Política de Estado. Além de garantir a continuidade do Programa, a Lei simplifica e desburocratiza os processos de prestação de contas e o repasse de recursos para as organizações da sociedade civil. Uma grande vitória para o movimento cultural brasileiro!</p>
        </div>
        <div class="row">
        ...
        <div class="row">
            <h3 id="o_que_ganho">O que eu ganho com isso?</h3>
            <p>Ser um Ponto ou Pontão de Cultura é um reconhecimento, por parte do Estado, de uma ação cultural continuada já desenvolvida por uma entidade ou coletivo cultural. Na prática, essas iniciativas já são "Pontos de Cultura" e “Pontões de Cultura”, antes de serem certificadas pelo MinC, pelo diálogo que estabelecem com sua comunidade e sua capacidade de atuação social e transformação do território.</p>
