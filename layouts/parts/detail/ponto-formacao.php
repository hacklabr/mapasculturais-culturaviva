    ...
    <div class="form">
        ...
        <div class="row">
            ...
            <label class="colunm1">
                ...
                <input disabled="true" type="text" ng-model="agent.formador1_nome">
            </label>
            <label class="colunm1">
                <span class="destaque">Email: </span>
                <input disabled="true" type="email" ng-model="agent.formador1_email">
            </label>
            <label class="colunm2">
                <span class="destaque">Telefone: </span>
                <input disabled="true" type="text" ng-model="agent.formador1_telefone" ui-mask="(99) ?99999 9999">
            </label>
            <label class="colunm2">
                <span class="destaque">Operadora: </span>
                <input disabled="true" type="text" ng-model="agent.formador1_operadora">
            </label>
            <label class="colunm1">
                <span class="destaque">Áreas de atuação (oficinas/atividades ministradas):</span>
                <input disabled="true" type="text" ng-model="agent.formador1_areaAtuacao">
            </label>
            <label class="colunm-full">
                <span class="destaque">Descrição/Mini-bio:  </span>
                <textarea disabled="true" ng-model="agent.formador1_bio"></textarea>
            </label>
            ...
            <label class="colunm-redes facebook">
                ...
                <input disabled="true" type="text" ng-model="agent.formador1_facebook" placeholder="http://"/>
            </label>

            <label class="colunm-redes twitter">
                <span><i class="icon icon-twitter"></i> Seu perfil no Twitter</span>
                <input disabled="true" type="text" ng-model="agent.formador1_twitter" placeholder="http://"/>
            </label>

            <label class="colunm-redes googleplus">
                <span><i class="icon icon-gplus"></i> Seu perfil no Google+</span>
                <input disabled="true" type="text" ng-model="agent.formador1_google" placeholder="http://"/>
            </label>
            ...
            <label class="colunm1">
                <span class="destaque">Áreas de atuação (oficinas/atividades ministradas):</span>
                <input disabled="true" type="text" ng-model="agent.espacoAprendizagem1_atuacao">
            </label>
            <div class="colunm-full">
            ...
            <label class="colunm1">
                ...
                <textarea disabled="true" ng-model="agent.espacoAprendizagem1_desc"></textarea>
            </label>
            ...
            <label class="colunm-full">
                ...
                <input disabled="true" type="text" ng-model="agent.metodologia1_nome">
            </label>
            <label class="colunm-full">
                <span class="destaque">Descrição:  </span>
                <textarea disabled="true" type="text" ng-model="agent.metodologia1_desc"></textarea>
            </label>
            <label class="colunm-full">
                <span class="destaque">Necessidades técnicas:  </span>
                <textarea disabled="true" type="text" ng-model="agent.metodologia1_necessidades"></textarea>
            </label>
            <label class="colunm1">
                <span class="destaque">Capacidade de público:  </span>
                 <input disabled="true" type="text" ng-model="agent.metodologia1_capacidade">
            </label>
            <label class="colunm1">
                <span class="destaque">Carga horária:  </span>
                 <input disabled="true" type="text" ng-model="agent.metodologia1_cargaHoraria">
            </label>
            <label class="colunm-full">
            ...
            <div class="colunm-50">
                <label class="label-radio">
                    <input disabled="true" type="radio"
                           name="certificacao"
                           ng-value="1" ng-model="agent.metodologia1_certificacao"> Sim</label>
                <label class="label-radio">
                    <input disabled="true" type="radio"
                           name="certificacao"
                           ng-value="0" ng-model="agent.metodologia1_certificacao"> Não </label>
            </div>
            <div class="colunm-full">
